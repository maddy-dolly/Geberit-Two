...
<div class="row">
<div class="col-md-4">
    <h2><img src="/icons/product.svg" style="height: 39px; width: 57px;">Edit Product:{{product['material_number']}}  </h2>
</div>
    <div class="ml-auto" style="margin-right:8px;">
        <router-link :to="{name:'productlist'}" class="btn btn-warning" style="color:white"><i class="fa fa-arrow-left"></i>&nbsp;Return to list</router-link>
    </div>
</div><br> 
<form @submit.prevent="editProduct">
        ...
        <div class="col-md-3">
           <div class="form-group">
                 <div class="form-group">
                    ...
                    <input  type="text" id="material_number" class="form-control" v-model.trim="$v.product.material_number.$model" :class="{'is-invalid' :$v.product.material_number.$error, 'is-valid' :!$v.product.material_number.$invalid}" style="border-radius:0px">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" v-model="product.description" style="border-radius:0px"></textarea>
        </div>
    </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" placeholder="" style="border-radius:0px;" v-model="product.list_price_usd" class="form-control">
            </div>
        </div>
        <div class="col-md-2">
             <div class="form-group">
                <label class="lab">List Price(SGD)</label>
                <input type="text" placeholder="" style="border-radius:0px;" v-model="product.list_price_sgd" class="form-control">
            </div>
        </div>
        <div class="col-md-2">
             <div class="form-group">
                <label class="lab">Product Line</label>
                <input type="text" placeholder="" style="border-radius:0px;" v-model="product.product_line" class="form-control">
            </div>
        </div>
        <div class="col-md-2">
          <div class="form-group">
        ...
        <div class="col-md-2">
             <div class="form-group">
                ...
                <input type="text" placeholder="" style="border-radius:0px;" v-model="product.origin_company" class="form-control">
            </div>
        </div>
    </div>
       ...
       <div class="form-group">
        ...
        <div class="col-md-2">
             <div class="form-group">
                ...
                <input type="date" placeholder="" style="border-radius:0px;" v-model="product.st51_since" class="form-control">
            </div>
        </div>
        <div class="col-md-2">
             <div class="form-group">
                <label class="lab">St52 Since</label>
                <input type="date" placeholder="" style="border-radius:0px;" v-model="product.st52_since" class="form-control">
            </div>
        </div>
        <div class="col-md-2">
             <div class="form-group">
                <label class="lab">Sales Replaced By</label>
                <input type="text" placeholder="" style="border-radius:0px;" v-model="product.sales_replaced_by" class="form-control">
            </div>
        </div>
        <div class="col-md-2">
             <div class="form-group">
                <label class="lab">No Sales In</label>
                <input type="text" placeholder="" style="border-radius:0px;" v-model="product.no_sales_in" class="form-control">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" style="border-radius:0px;" v-model="product.quantity_pu_1" placeholder="">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="lab">Quantity PU2</label>
                <input type="text" class="form-control" style="border-radius:0px;" v-model="product.quantity_pu_2" placeholder="">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="lab">Quantity PU3</label>
                <input type="text" class="form-control" style="border-radius:0px;" v-model="product.quantity_pu_3" placeholder="">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="lab">Quantity PU4</label>
                <input type="text" class="form-control" style="border-radius:0px;" v-model="product.quantity_pu_4" placeholder="">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="lab">Net Weight</label>
                <input type="text" class="form-control" style="border-radius:0px;" v-model="product.net_weight" placeholder="">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label class="lab">Gross Weight</label>
                <input type="text" class="form-control" style="border-radius:0px;" v-model="product.gross_weight" placeholder="">
            </div>
        </div>
    </div>
    <div class="row" style="margin: 12px 0px;">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" placeholder="" class="form-control" style="border-radius:0px;" v-model="product.volume_pu_1">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>Volume PU2</label>
                <input type="text" placeholder="" class="form-control" style="border-radius:0px;" v-model="product.volume_pu_2">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>Volume PU3</label>
                <input type="text" placeholder="" class="form-control" style="border-radius:0px;" v-model="product.volume_pu_3">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>Volume PU4</label>
                <input type="text" placeholder="" class="form-control" style="border-radius:0px;" v-model="product.volume_pu_4">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>Unit Volume</label>
                <input type="text" placeholder="" class="form-control" style="border-radius:0px;" v-model="product.unit_volume">
            </div>
        </div>
    </div>
    <div class="row" style="margin: 12px 0px;">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" placeholder="" class="form-control" v-model="product.base_unit" style="border-radius:0px;">
            </div>
        </div>
         <div class="col-md-3">
            <div class="form-group">
                <label class="lab">Weight Unit</label>
                <input type="text" placeholder="" class="form-control" v-model="product.weight_unit" style="border-radius:0px;">
            </div>
        </div>
    </div>
    <div class="row" style="margin: 12px 0px;">
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="" style="border-radius:0px;" v-model="product.step_relevant">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>Product Hierarchy</label>
                <input type="text" class="form-control" placeholder="" style="border-radius:0px;" v-model="product.product_hierarchy">
            </div>
        </div>
        <div class="col-md-2">
            <div class="form-group">
                <label>PM</label>
                <input type="text" class="form-control" placeholder="" style="border-radius:0px;" v-model="product.pm">
            </div>
        </div>
    </div>
</div>
<div class="row">
           ...
           <div class="col-md-4"></div>
           <div class="col-md-4">
        <button class="btn btn-primary save" @click="$v.product.$touch" title="update product">Save<i class="fa fa-check"></i></button>
           </div>
</div>
       </div>
  ...
  product:{
    ...
    methods:{
      ...
      getRecord() {
        var app=this;
       this.$http({
                url: `showproduct/`+this.$route.params.id,
                method: 'GET',
                })
                .then((res) => {
                app.product= res.data.product;
                //console.log(app.product);
                for (var propName in app.product) { 
                    if (app.product[propName] === null || app.product[propName] === undefined) {
                        app.product[propName] = '';
                    }
                }
                //console.log(app.product);
      ...
      editProduct() {
        ...
        console.log(app.product.st51_since);
        
          
          

           this.$http.post ( 'updateproduct/'+this.$route.params.id, formData ).then(function (res) {
                    if (res.data.status=="success"){
                        app.$toasted.success('Product updated successfully'); 
