...
<body>
    ...
    margin-left: 35%;"></p>
        ...
        <p style="padding:0 15px;">A new quotation with reference No.: {{$quotation->refrence_number}}  has been approved.</p>
    ...
    height: 36px">
        ...
        <td>{{$quotation->currency}} {{$quotation->quotation_cost}}</td>
      </tr>
      <tr style=" height: 36px">
        <th style="font-weight:bold;
       ...
       <center>
        <h2 style="background:white;padding: 0 15px;">
            <a href="http://192.168.18.127:8000/viewquotation/{{$quotation->id}}" style="background-color: #008CBA;
