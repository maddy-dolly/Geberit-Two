...
<body>
    ...
    border-bottom: 1px solid #ddd;"><img style=" height: 45%;
    margin-left: 35%;" src="http://54.255.235.110/images/logo.png"></p>
        
        <p style="font-weight:bold;color:black;padding: 0 15px;">Hello {{$user->name}} ({{$user->role->display_name}}),</p>
        <p style="padding:0 15px;">A new quotation with reference No.: {{$quotation_update->refrence_number}}  has been rejected.</p>
    ...
    height: 36px">
      ...
      <tr style=" height: 36px">
        <th style="font-weight:bold;
            color:black;">Reason </th>
        <td>: {{$quotation_update->reason}}</td>
      </tr>
       ...
       <center>
        <h2 style="background:white;padding: 0 15px;">
            <a href="http://192.168.18.127:8000/viewquotation/{{$quotation_update->id}}"  style="    background-color: #4CAF50; /* Green */
            border: none;
            color: white;
            padding: 15px 32px;
            text-align: center;
...
color:white;font-weight:bold">Go to Quotation</a>
        </h2>
        </center>
    </div>
</body>
